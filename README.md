...
- Type `curl -L -O https://github.com/alexmekic/pxe-server-deployment/releases/download/2.1.2/PXEDeploy2.1.2.zip` to download all the required files
- Unzip it with `unzip PXEDeploy2.1.2.zip`
